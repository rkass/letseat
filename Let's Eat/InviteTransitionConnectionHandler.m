...
+(Invitation*)loadInvitation:(NSDictionary*)resultsDictionary locationInput:(CLLocation*)locationInput
{
    ...
    for (NSMutableDictionary* rest in resultsDictionary[@"invitation"][@"restaurants"])
        [i.restaurants addObject:[[Restaurant alloc] init:rest[@"address"] nameInput:rest[@"name"] percentMatchInput:rest[@"percentMatch"] priceInput:rest[@"price"] ratingImgInput:rest[@"rating_img"] snippetImgInput:rest[@"snippet_img"] votesInput:rest[@"votes"] typesInput:rest[@"types_list"] iVotedInput:[rest[@"user_voted"] boolValue] urlInput:rest[@"url"] myLocationInput:locationInput invitationInput:i.num]];
